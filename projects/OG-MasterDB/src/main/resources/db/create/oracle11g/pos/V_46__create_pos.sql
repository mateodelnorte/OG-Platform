...
CREATE TABLE pos_trade (
    id decimal(19) NOT NULL,
    oid decimal(19) NOT NULL,
    position_id decimal(19) NOT NULL,
    position_oid decimal(19) NOT NULL,
    quantity decimal(31,8) NOT NULL,
    trade_date date NOT NULL,
    trade_time TIMESTAMP null,
    zone_offset INTEGER null,
...
CREATE TABLE pos_trade_attribute (
    id decimal(19) NOT NULL,
    trade_id decimal(19) NOT NULL,
    trade_oid decimal(19) NOT NULL,
